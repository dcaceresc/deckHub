        ...
        <div class="max-w-xl mx-auto">
            <div class="bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                <div class="p-6">
                    ...
                    <form action="{{ route('admin.card-types.store') }}" method="POST" class="space-y-4">
                        @csrf
                        ...
                        <div>
                            <label for="games"
                                class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Juegos</label>
